...
public final class LivePreviewActivity extends AppCompatActivity
  ...
  public void generateNoteOnSD(String sFileName, String sBody) {
    ...
    try {
      ...
      Log.e("LIJU",e.getMessage());
    }
  }
  boolean check() {

    return PermissionChecker.checkSelfPermission(getApplicationContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED
            && PermissionChecker.checkSelfPermission(getApplicationContext(), Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED;
  }
  ...
  public void getPermission() {
    ...
    if ((ContextCompat.checkSelfPermission(this,
      ...
      ActivityCompat.requestPermissions(LivePreviewActivity.this,
